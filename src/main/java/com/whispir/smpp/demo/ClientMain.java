...
public class ClientMain {
    ...
    static public void main(String[] args) throws Exception {
        ...
        config0.setHost("smpp.au.whispir.com");
        config0.setPort(14300);
        config0.setConnectTimeout(10000);
        config0.setSystemId("<enter-username>");
        config0.setPassword("<enter-password>");
        ...
        try {
            ...
            String text160 = "SMS via SMPP in Java!";
